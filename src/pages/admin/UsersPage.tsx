      ...
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {employee.role === 'CEO' && <span className="rounded-full bg-info/10 px-2 py-0.5 text-caption font-bold uppercase tracking-wide text-info">CEO</span>}
          </div>
          ...
          <div className="mt-3 space-y-2">
            <div>
              ...
              <div className="mt-1 flex flex-wrap gap-1.5">
                {(employee.departments || []).length ? (employee.departments || []).map(item => <span key={item.id} className="rounded-full border border-border bg-surface px-2 py-1 text-caption font-semibold text-muted-foreground">{item.name}</span>) : <span className="text-body-sm text-muted-foreground">No department membership</span>}
              </div>
            </div>
            <div>
              <p className="text-caption font-bold uppercase tracking-[.12em] text-muted">Owns</p>
              <div className="mt-1 flex flex-wrap gap-1.5">
                {(employee.owned_departments || []).length ? (employee.owned_departments || []).map(item => <span key={item.id} className="rounded-full border border-primary/15 bg-primary/10 px-2 py-1 text-caption font-semibold text-primary">{item.name}</span>) : <span className="text-body-sm text-muted-foreground">No owned departments</span>}
              </div>
            </div>
          </div>
        </div>
